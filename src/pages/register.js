    ...
    render () {
        return(
            <Container className="container d-flex justify-content-center align-items-center">
                ...
                <Card.Header className="card-header bg-warning text-white text-center"><strong>Register</strong></Card.Header>
                <Card.Body>
                    { !this.state.logged ? 
                        (
                    ...
                    <Nav.Link><Link to='/login'><Button variant="warning" type="submit">Let's Login</Button></Link></Nav.Link>
                    </Form>
                </Card.Body>
                </Card>
            </Container>
