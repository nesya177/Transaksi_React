  ...
  return header
    ...
    render(){
        ...
        return(
            ...
            <NavBar />
            <Card>
                <Card.Header className="card-header bg-secondary text-white" align={'center'}>Data Jurusan</Card.Header>
                <Card.Body>
                ...
                <Modal show={this.state.isModalOpen} onHide={this.handleClose}>
                    ...
                    ID Jurusan
                        ...
                        className="form-control" required />
                        Keterangan
                        <input type="text" name="keterangan" value={this.state.keterangan} onChange={this.bind}  
                        className="form-control" required /> 
